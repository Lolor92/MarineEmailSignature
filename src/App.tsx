      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-600">
            This Outlook-safe version uses a single hosted image so the logo and background stay intact.
          </p>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-cyan-100 bg-cyan-50 p-6">
          <h3 className="mb-3 text-lg font-semibold text-cyan-950">How to use it in Outlook</h3>
          <ol className="list-inside list-decimal space-y-2 text-sm text-cyan-900">
            ...
            <li>If Outlook shows a blocked image banner, allow picture downloads for this message.</li>
          </ol>
          <p className="mt-4 text-sm text-cyan-800">
            Outlook desktop commonly strips CSS background images from pasted HTML signatures. Using a
            single hosted image is the reliable option when you need the exact same appearance.
          </p>
        </div>
      </div>
    </div>
